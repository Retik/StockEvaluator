...
namespace Avapi.AvapiTIME_SERIES_WEEKLY_ADJUSTED
{
	...
	public class Impl_TIME_SERIES_WEEKLY_ADJUSTED : Int_TIME_SERIES_WEEKLY_ADJUSTED
	{
		...
		internal static readonly IDictionary s_TIME_SERIES_WEEKLY_ADJUSTED_datatype_translation
			 = new Dictionary<Const_TIME_SERIES_WEEKLY_ADJUSTED.TIME_SERIES_WEEKLY_ADJUSTED_datatype, string>()
		{
			{
				Const_TIME_SERIES_WEEKLY_ADJUSTED.TIME_SERIES_WEEKLY_ADJUSTED_datatype.none,
				null
			},
			{
				Const_TIME_SERIES_WEEKLY_ADJUSTED.TIME_SERIES_WEEKLY_ADJUSTED_datatype.json,
				"json"
			},
			{
				Const_TIME_SERIES_WEEKLY_ADJUSTED.TIME_SERIES_WEEKLY_ADJUSTED_datatype.csv,
				"csv"
			}
		};

		 public IAvapiResponse_TIME_SERIES_WEEKLY_ADJUSTED Query(
			string symbol,
		...
		{
			string current_datatype = s_TIME_SERIES_WEEKLY_ADJUSTED_datatype_translation[datatype] as string;
