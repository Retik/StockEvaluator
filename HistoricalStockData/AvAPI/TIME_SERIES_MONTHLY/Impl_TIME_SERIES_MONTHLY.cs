...
namespace Avapi.AvapiTIME_SERIES_MONTHLY
{
	...
	public class Impl_TIME_SERIES_MONTHLY : Int_TIME_SERIES_MONTHLY
	{
		...
		internal static readonly IDictionary s_TIME_SERIES_MONTHLY_datatype_translation
			 = new Dictionary<Const_TIME_SERIES_MONTHLY.TIME_SERIES_MONTHLY_datatype, string>()
		{
			{
				Const_TIME_SERIES_MONTHLY.TIME_SERIES_MONTHLY_datatype.none,
				null
			},
			{
			...
			{
				Const_TIME_SERIES_MONTHLY.TIME_SERIES_MONTHLY_datatype.csv,
				"csv"
			}
		};

		 public IAvapiResponse_TIME_SERIES_MONTHLY Query(
			string symbol,
		...
		{
			string current_datatype = s_TIME_SERIES_MONTHLY_datatype_translation[datatype] as string;
