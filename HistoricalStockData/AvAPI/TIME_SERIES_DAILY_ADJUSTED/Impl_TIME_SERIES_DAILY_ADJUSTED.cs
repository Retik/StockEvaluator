...
namespace Avapi.AvapiTIME_SERIES_DAILY_ADJUSTED
{
	...
	public class Impl_TIME_SERIES_DAILY_ADJUSTED : Int_TIME_SERIES_DAILY_ADJUSTED
	{
		...
		internal static readonly IDictionary s_TIME_SERIES_DAILY_ADJUSTED_datatype_translation
			 = new Dictionary<Const_TIME_SERIES_DAILY_ADJUSTED.TIME_SERIES_DAILY_ADJUSTED_datatype, string>()
		{
			{
				Const_TIME_SERIES_DAILY_ADJUSTED.TIME_SERIES_DAILY_ADJUSTED_datatype.none,
				null
			},
			{
			...
			{
				Const_TIME_SERIES_DAILY_ADJUSTED.TIME_SERIES_DAILY_ADJUSTED_datatype.csv,
				"csv"
			}
		};
			...
			Const_TIME_SERIES_DAILY_ADJUSTED.TIME_SERIES_DAILY_ADJUSTED_datatype datatype = Const_TIME_SERIES_DAILY_ADJUSTED.TIME_SERIES_DAILY_ADJUSTED_datatype.none)
		{
			...
			string current_datatype = s_TIME_SERIES_DAILY_ADJUSTED_datatype_translation[datatype] as string;
