...
namespace Avapi.AvapiDIGITAL_CURRENCY_INTRADAY
{
	...
	public class Impl_DIGITAL_CURRENCY_INTRADAY : Int_DIGITAL_CURRENCY_INTRADAY
	{
		...
		internal static readonly IDictionary s_DIGITAL_CURRENCY_INTRADAY_datatype_translation
			 = new Dictionary<Const_DIGITAL_CURRENCY_INTRADAY.DIGITAL_CURRENCY_INTRADAY_datatype, string>()
		{
			{
				Const_DIGITAL_CURRENCY_INTRADAY.DIGITAL_CURRENCY_INTRADAY_datatype.none,
				null
			},
			{
				Const_DIGITAL_CURRENCY_INTRADAY.DIGITAL_CURRENCY_INTRADAY_datatype.json,
				"json"
			},
			{
				Const_DIGITAL_CURRENCY_INTRADAY.DIGITAL_CURRENCY_INTRADAY_datatype.csv,
				"csv"
			}
		};

		 public IAvapiResponse_DIGITAL_CURRENCY_INTRADAY Query(
			string symbol,
			string market,
		...
		{
			string current_datatype = s_DIGITAL_CURRENCY_INTRADAY_datatype_translation[datatype] as string;
