...
namespace Avapi.AvapiBATCH_STOCK_QUOTES
{
	...
	public class Impl_BATCH_STOCK_QUOTES : Int_BATCH_STOCK_QUOTES
	{
		...
		internal static readonly IDictionary s_BATCH_STOCK_QUOTES_datatype_translation
			 = new Dictionary<Const_BATCH_STOCK_QUOTES.BATCH_STOCK_QUOTES_datatype, string>()
		{
			{
				Const_BATCH_STOCK_QUOTES.BATCH_STOCK_QUOTES_datatype.none,
				null
			},
			{
				Const_BATCH_STOCK_QUOTES.BATCH_STOCK_QUOTES_datatype.json,
				"json"
			},
			{
				Const_BATCH_STOCK_QUOTES.BATCH_STOCK_QUOTES_datatype.csv,
				"csv"
			}
		};

		 public IAvapiResponse_BATCH_STOCK_QUOTES Query(
			string symbols,
			Const_BATCH_STOCK_QUOTES.BATCH_STOCK_QUOTES_datatype datatype = Const_BATCH_STOCK_QUOTES.BATCH_STOCK_QUOTES_datatype.none)
		{
			string current_datatype = s_BATCH_STOCK_QUOTES_datatype_translation[datatype] as string;

			return Query(symbols,current_datatype);
		}
