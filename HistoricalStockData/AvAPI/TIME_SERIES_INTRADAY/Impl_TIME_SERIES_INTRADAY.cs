...
namespace Avapi.AvapiTIME_SERIES_INTRADAY
{
	...
	public class Impl_TIME_SERIES_INTRADAY : Int_TIME_SERIES_INTRADAY
	{
		...
		internal static readonly IDictionary s_TIME_SERIES_INTRADAY_datatype_translation
			 = new Dictionary<Const_TIME_SERIES_INTRADAY.TIME_SERIES_INTRADAY_datatype, string>()
		{
			{
				Const_TIME_SERIES_INTRADAY.TIME_SERIES_INTRADAY_datatype.none,
				null
			},
			{
			...
			{
				Const_TIME_SERIES_INTRADAY.TIME_SERIES_INTRADAY_datatype.csv,
				"csv"
			}
		};
	    ...
	    {
	        return QueryAsync(symbol, interval, outputsize, datatype).Result;
	    }

	    public Task<IAvapiResponse_TIME_SERIES_INTRADAY> QueryAsync(
	        string symbol,
	        Const_TIME_SERIES_INTRADAY.TIME_SERIES_INTRADAY_interval interval,
	        Const_TIME_SERIES_INTRADAY.TIME_SERIES_INTRADAY_outputsize outputsize = Const_TIME_SERIES_INTRADAY.TIME_SERIES_INTRADAY_outputsize.none,
	        Const_TIME_SERIES_INTRADAY.TIME_SERIES_INTRADAY_datatype datatype = Const_TIME_SERIES_INTRADAY.TIME_SERIES_INTRADAY_datatype.none)
	    {
	        ...
	        string current_datatype = s_TIME_SERIES_INTRADAY_datatype_translation[datatype] as string;

	        return QueryAsync(symbol,current_interval,current_outputsize,current_datatype);
	    }
	        ...
	        string datatype = null)
	    {
	        ...
	        if (RestClient != null)
	        {
	            var response = await RestClient.GetAsync(queryString);
	            if (response != null)
	                responseString = await response.Content.ReadAsStringAsync();
	        }

	        var ret = new AvapiResponse_TIME_SERIES_INTRADAY
	        {
	            RawData = responseString,
	            Data = ParseInternal(responseString),
